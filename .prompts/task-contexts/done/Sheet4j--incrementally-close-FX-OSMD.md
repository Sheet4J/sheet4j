...
> **Superseded** by `done/Switch-reference-comparison-from.md`. The OSMD
> reference is no longer used: `CompareFxViewWithReferenceTest` now diffs
> against the sibling PDF committed next to each MusicXML fixture,
> rasterized in-process via PDFBox.
