 ...
 *
 * <p>The score is rendered headlessly with the production {@link com.sheet4j.fxviewer.ScorePainter}
...
class CompareFxViewWithPdfTest {
    ...
    private static final double THRESHOLD =
            Double.parseDouble(System.getProperty("sheet4j.compare.threshold", "0.6"));
